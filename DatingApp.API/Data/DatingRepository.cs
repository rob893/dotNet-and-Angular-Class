...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        {
            IQueryable<Message> messages = context.Messages.Include(u => u.Sender).ThenInclude(p => p.Photos).Include(u => u.Recipient).ThenInclude(p => p.Photos);
        ...
        {
            List<Message> messages = await context.Messages.Include(u => u.Sender).ThenInclude(p => p.Photos)
